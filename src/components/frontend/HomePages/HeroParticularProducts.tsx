  ...
  const tabs = [
    ...
    },
    {
      ...
      content: {
        title: "TV Soundbars",
        description:
          "Upgrade your TV audio with our premium soundbars. Experience immersive surround sound with sleek, easy-to-install audio solutions that complement any TV setup.",
        features: [
          "Dolby Atmos Support",
          "Wireless Subwoofers",
    ...
    },
    {
      ...
      content: {
        ...
        description:
          "Complete your home entertainment system with our range of essential TV accessories. From mounts and brackets to HDMI cables and universal remotes, we have everything you need.",
        features: [
          "Wall Mounts",
          "HDMI 2.1 Cables",
          "Universal Remotes",
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <div>
                      ...
                      <motion.div
                        ...
                        className="mt-8 "
                      >
                        <button className="px-6 py-3 cursor-pointer bg-[#0C2730] hover:bg-[#0c2730ea] text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="">
                  ...
                  <motion.div variants={tabVariants} className="mt-8">
                    <button className="px-6 py-3 bg-[#0C2730] hover:bg-[#0c2730ea] text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
