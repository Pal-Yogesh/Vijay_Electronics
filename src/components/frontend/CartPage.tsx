                ...
                <ul className="divide-y divide-gray-200">
                  <AnimatePresence>
                    {cartItems.map((item) => (
                      ...
                      >
                        <div className="flex-shrink-0 bg-gray-100 rounded-md w-24 h-24 flex items-center justify-center overflow-hidden">
                          <img
                            src={item.image}
                            alt={item.name}
                  ...
                  <div className="pt-4">
                    <div className="flex space-x-2 mt-2">
                      <input
                        ...
                        className="flex-1 px-3 py-2 text-sm border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent"
                      />
                      <button className="bg-gray-200 text-gray-800 text-sm px-4 py-2 rounded hover:bg-gray-300 transition-colors">
                        Apply
                      </button>
                    </div>
                  </div>
